...
function renderGrafico() {
  ...
  chartInstance = new Chart(graficoCanvas, {
    ...
    data: {
      ...
      datasets: [{ data: [ingresos, gastos], backgroundColor: ["#4caf50", "#f44336"] }]
    },
    options: {
      responsive: false,
      ...
      plugins: {
        ...
        tooltip: {
          callbacks: {
            label: ctx => `${ctx.label}: ${ctx.raw.toLocaleString('de-DE', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} €`
          }
        }
      }
    }
